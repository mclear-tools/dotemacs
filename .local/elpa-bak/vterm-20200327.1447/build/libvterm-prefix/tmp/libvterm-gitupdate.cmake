...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref 65dbda3ed214f036ee799d18b2e693a833a0e591
  WORKING_DIRECTORY "/Users/roambot/.emacs.d/.local/elpa/vterm-20200327.1447/build/libvterm-prefix/src/libvterm"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 65dbda3ed214f036ee799d18b2e693a833a0e591
  WORKING_DIRECTORY "/Users/roambot/.emacs.d/.local/elpa/vterm-20200327.1447/build/libvterm-prefix/src/libvterm"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/roambot/.emacs.d/.local/elpa/vterm-20200327.1447/build/libvterm-prefix/src/libvterm/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/roambot/.emacs.d/.local/elpa/vterm-20200327.1447/build/libvterm-prefix/src/libvterm/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
