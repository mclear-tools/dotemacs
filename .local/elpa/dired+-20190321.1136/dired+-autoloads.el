...
(defvar diredp-omit-files-regexp (let* ((strg dired-omit-files) (strg (if (eq 94 (aref strg 0)) (substring strg 1) strg)) (strg (replace-regexp-in-string "\\(\\\\[|]\\)\\^" "\\1" strg 'FIXEDCASE nil)) (strg (replace-regexp-in-string "\\([$]\\)" "" strg 'FIXEDCASE nil))) strg) "\
...
(custom-autoload 'diredp-omit-files-regexp "dired+" t)
...
\(fn BOOKMARK-FILE &optional PREFIX ARG DETAILS)" t nil)
...
(autoload 'diredp-mark-sexp-recursive "dired+" "\
...
\(fn PREDICATE &optional ARG DETAILS)" t nil)
