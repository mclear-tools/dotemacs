...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "centaur-tabs" '("centaur-tabs-" "ivy-source-centaur-tabs-group" "helm-source-centaur-tabs-group" "after-modifying-buffer" "on-")))
