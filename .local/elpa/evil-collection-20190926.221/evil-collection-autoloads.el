...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-2048-game" '("evil-collection-2048-game-maps")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-apropos" '("evil-collection-apropos-maps")))
...
;;;***

;;;### (autoloads nil "evil-collection-docker" "evil-collection-docker.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from evil-collection-docker.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-docker" '("evil-collection-docker-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-elisp-slime-nav" '("evil-collection-elisp-slime-nav-maps")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-hg-histedit" '("evil-collection-hg-histedit-maps")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-hungry-delete" '("evil-collection-hungry-delete")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-leetcode" '("evil-collection-leetcode-maps")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-monky" '("evil-collection-monky-maps")))
...
;;;***

;;;### (autoloads nil "evil-collection-tablist" "evil-collection-tablist.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from evil-collection-tablist.el

(autoload 'evil-collection-tablist-setup "evil-collection-tablist" "\
Set up `evil' bindings for `tablist'.

\(fn)" nil nil)

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-tablist" '("evil-collection-tablist-maps")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "evil-collection-unimpaired" '("evil-collection-unimpaired-")))
