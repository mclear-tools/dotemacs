...
(let* (;; variable pitch
    ...
    (custom-theme-set-faces
     ...
     `(company-preview-common                    ((,class (:underline t :foreground ,light1))
                                                  (,t-class (:underline t :foreground ,t-light1))))
     ...
     `(company-scrollbar-bg                      ((,class (:foreground nil :background ,dark3))
                                                  (,t-class (:foreground nil :background ,t-dark3))))
     ...
     `(company-preview-common                    ((,class (:inherit font-lock-comment-face))
                                                  (,t-class (:inherit font-lock-comment-face))))
     `(company-tooltip-common                    ((,class (:foreground ,light1 :background ,dark1))
     ...
     `(dired-ignored                             ((,class (:inherit font-lock-comment-face))
                                                  (,t-class (:inherit font-lock-comment-face))))
     `(dired-mark                                ((,class (:foreground ,bright_red :weight bold))
     ...
     ;; Message faces
     `(message-header-name                       ((,class (:foreground ,light1))
                                                  (,t-class (:foreground ,t-light1))))
...
;;;;; mingus
     ...
     `(org-deadline-announce                     ((,class (:foreground ,neutral_red))
                                                  (,t-class (:foreground ,t-neutral_red))))
     `(org-document-title                        ((,class (:background ,dark0_hard :foreground ,neutral_red :weight bold :height ,(if omtose-softer-org-height 1.3 1.0) :underline t))
                                                  (,t-class (:background ,t-dark0_hard :foreground ,t-neutral_red :weight bold :height ,(if omtose-softer-org-height 1.3 1.0) :underline t))))
     ...
     `(org-level-2                               ((,class (:foreground ,delimiter-one :height ,(if omtose-softer-org-height 1.1 1.0)))
                                                  (,t-class (:foreground ,t-delimiter-one :height ,(if omtose-softer-org-height 1.1 1.0)))))
