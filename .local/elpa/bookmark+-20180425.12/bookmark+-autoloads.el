...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bookmark+-1" '("bookmark" "bmk")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bookmark+-bmu" '("bookmark-bmenu-" "bmkp-" "menu-bar-edit-menu" "list-bookmarks")))
