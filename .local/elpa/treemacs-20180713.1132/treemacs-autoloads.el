...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "treemacs-macros" '("treemacs-" "only-during-treemacs-init" "-if-let-" "-unless-let" "-when-let-" "-let" "-pcase" "-defstruct")))
