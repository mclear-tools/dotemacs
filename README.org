...
1. Short start up time -- starts in less than 1 sec (this may vary
   with your system)
...
6. [[file:setup-config/setup-dired.el][Dired]] with good colors 
...
10. An attractive custom [[file:setup-config/setup-modeline.el][mode-line]] (related to bespoke-themes)
11. Extensive [[file:setup-config/setup-osx.el][MacOS integration]]
12. Single frame workspace [[file:setup-config/setup-projects.el][project]] workflow with project.el and tab-bar (both built-in) 
