...
[[https://www.colinmclear.net/posts/texteditor/][best way]] to use a [[https://en.wikipedia.org/wiki/Text_editor][text-editor]]. If you like vim bindings but don't tend to want to
