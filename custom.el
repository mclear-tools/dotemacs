...
(custom-set-faces
 ...
 '(diredfl-dir-priv ((t (:foreground "#7474FFFFFFFF"))))
 '(diredfl-exec-priv ((t nil)))
 '(diredfl-no-priv ((t (:foreground "#2C2C2C2C2C2C"))))
 '(diredfl-read-priv ((t (:foreground "#999932325555"))))
 '(diredfl-tagged-autofile-name ((t (:foreground "#328C0411328"))))
 '(diredfl-write-priv ((t (:foreground "#25258F8F2929"))))
